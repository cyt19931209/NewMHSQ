...
//    midView.layer.borderColor = [RGBColor colorWithHexString:@"#999999"].CGColor;
    ...
    view.frame = CGRectMake(kScreenWidth/2 - 120, loginButton.bottom + 12, 240, 28);
    ...
    label.frame = CGRectMake(43, 8, 187, 12);
    label.text = @"该帐号也可用于闲货App";
    ...
    UIImageView *imageV = [[UIImageView alloc]initWithFrame:CGRectMake(8, 2, 24, 24)];
